...
from app.models.experimental import MixConv2d
from app.utils.autoanchor import check_anchor_order
from app.utils.general import LOGGER, check_version, check_yaml, colorstr, make_divisible, print_args
from app.utils.plots import feature_visualization
...
if __name__ == "__main__":
    ...
    if opt.line_profile:  # profile layer by layer
        ...
        for cfg in Path(ROOT / "app" / "models").rglob("yolo*.yaml"):
            try:
                _ = Model(cfg)
