...
from app.utils import TryExcept, emojis
from app.utils.downloads import curl_download, gsutil_getsize
from app.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from app.models.common import AutoShape, DetectMultiBackend
...
def strip_optimizer(f="best.pt", s=""):
    ...
    Example: from app.utils.general import *; strip_optimizer()
    """
