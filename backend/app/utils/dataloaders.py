...
from app.utils.torch_utils import torch_distributed_zero_first
...
def extract_boxes(path=DATASETS_DIR / "coco128"):
    ...
    Example: from app.utils.dataloaders import *; extract_boxes()
    """
...
def autosplit(path=DATASETS_DIR / "coco128/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from app.utils.dataloaders import *; autosplit().
...
class HUBDatasetStats:
    ...
    Usage
        from app.utils.dataloaders import HUBDatasetStats
